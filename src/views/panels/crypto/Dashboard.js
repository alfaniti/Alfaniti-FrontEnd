              ...
              <Card className="rounded-0">
                <Card.Body>
                  <Row className="justify-content-between align-items-center mb-3">
                    ...
                    <Col>
                      <h6 className="badge bg-warning float-right d-inline-block m-0">-0.997896</h6>
                    </Col>
                  </Row>
                  <Chart {...coinChart1} />
                </Card.Body>
              ...
              <Card className="rounded-0">
                <Card.Body>
                  <Row className="justify-content-between align-items-center mb-3">
                    ...
                    <Col>
                      <h6 className="badge bg-danger float-right d-inline-block m-0">+1.1456</h6>
                    </Col>
                  </Row>
                  <Chart {...coinChart2} />
                </Card.Body>
              ...
              <Card className="rounded-0">
                <Card.Body>
                  <Row className="justify-content-between align-items-center mb-3">
                    ...
                    <Col>
                      <h6 className="badge bg-primary float-right d-inline-block m-0">+5.78787</h6>
                    </Col>
                  </Row>
                  <Chart {...coinChart3} />
                </Card.Body>
              ...
              <Card className="rounded-0">
                <Card.Body>
                  <Row className="justify-content-between align-items-center mb-3">
                    ...
                    <Col>
                      <h6 className="badge bg-success float-right d-inline-block m-0">-7.99999</h6>
                    </Col>
                  </Row>
                  <Chart {...coinChart4} />
                </Card.Body>
