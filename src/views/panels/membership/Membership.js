        ...
        <Col sm={4}>
          <Card>
            <Card.Body className="text-center">
              ...
              <p>
                <span className="badge bg-primary">16 Sales</span>{' '}
              </p>
              <hr />
        ...
        <Col sm={4}>
          <Card>
            <Card.Body className="text-center">
              ...
              <p>
                <span className="badge bg-primary">26 Sales</span>{' '}
              </p>
              <hr />
              <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}>
                <i className="feather icon-edit-2" />
        ...
        <Col sm={4}>
          <Card>
            <Card.Body className="text-center">
              ...
              <p>
                <span className="badge bg-primary">29 Sales</span>{' '}
              </p>
              <hr />
              <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}>
                <i className="feather icon-edit-2" />
        ...
        <Col sm={4}>
          <Card>
            <Card.Body className="text-center">
              ...
              <p>
                <span className="badge bg-primary">0 Sales</span>{' '}
              </p>
              <hr />
              <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}>
                <i className="feather icon-edit-2" />
