                ...
                <div className="cat-list">
                  <div className="border-bottom pb-3 ">
                    ...
                    <div className="float-right span-content">
                      <Link
                        to="#"
                        className="btn waves-effect waves-light btn-default bg-danger rounded-circle mr-1"
                        data-toggle="tooltip"
                        data-placement="top"
                        title=""
                        data-original-title="tooltip on top"
                      ...
                      <Link
                        to="#"
                        className="btn waves-effect waves-light btn-default bg-secondary rounded-circle mr-0 "
                        data-toggle="tooltip"
                        data-placement="top"
                        title=""
                        data-original-title="tooltip on top"
        ...
        <div className="content">
          <Card.Body>
            <h4>
              ...
              <span className="badge bg-danger text-uppercase ml-2 f-12">Private</span>
            </h4>
            <div className="border-bottom pb-3 pt-3">
              <div className="row">
          ...
          <Col sm={12}>
            <Card className="border-0 shadow-none">
              ...
              <Row className="border-bottom border-top pb-3 pt-4 pl-3 pr-3">
                ...
                <Col>
                  <h6 className="mb-0">
                    Support Agent name<span className="badge bg-secondary ml-2">Support Agent</span>
                  </h6>
