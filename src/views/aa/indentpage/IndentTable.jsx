  ...
  const columns = React.useMemo(
    () => [
...

      {
        ...
        accessor: 'priority',
        Cell:({row})=>{
          if(row.values.priority ===null || 0){
            return <Button size="sm" variant="danger">Low</Button>
          }
          else if (row.values.priority===1){
            return<Button size="sm" variant="primary">Medium</Button>
          }
          else {
            return<Button size="sm" variant="success">High</Button>
          }
        }
