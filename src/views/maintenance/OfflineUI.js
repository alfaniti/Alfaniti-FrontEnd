        ...
        <div className="offline-wrapper">
          ...
          <Container className="off-main">
            <Row className="justify-content-center">
              <Col xs={6}>
                <div className="text-center">
                  <div className="moon" />
                  <img src={'../../assets/images/maintenance/ship.svg'} alt="" className="img-fluid boat-img" />
                </div>
              </Col>
            </Row>
            <Row className="m-0 justify-content-center off-content">
              ...
              <div className="sark">
                <img src={'../../assets/images/maintenance/sark.svg'} alt="" className="img-fluid img-sark" />
