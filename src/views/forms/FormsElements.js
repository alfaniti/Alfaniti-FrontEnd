            ...
            <Card.Body>
              <Row>
                <Col md={12}>
                  ...
                  <hr />
                  <Form.Group>
                    <Form.Check custom="true" type="checkbox" id="checkbox1" label="Check this custom checkbox" />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  ...
                  <hr />
                  <Form.Group>
                    <Form.Check custom="true" type="radio" label="Toggle this custom radio" name="supportedRadios" id="supportedRadio3" />
                    <Form.Check
                      custom="true"
                      type="radio"
                      label="Or toggle this other custom radio"
