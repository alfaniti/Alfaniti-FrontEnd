                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div>
                            <label className="badge bg-warning">Pending</label>
                          </div>
                        </td>
                        <td>$10</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div>
                            <label className="badge bg-danger">Cancel</label>
                          </div>
                        </td>
                        <td>$20</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div>
                            <label className="badge bg-success">Success</label>
                          </div>
                        </td>
                        <td>$35</td>
                        <td>
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>04/08/2018</td>
                        <td>
                          <label className="badge bg-success">Paid</label>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>04/08/2019</td>
                        <td>
                          <label className="badge bg-danger">Unpaid</label>
                        </td>
                      </tr>
                      <tr>
                  ...
                  <Table responsive>
                    <tbody>
                      <tr>
                        ...
                        <td className="text-right">
                          <label className="badge bg-warning m-0">43%</label>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className="text-right">
                          <label className="badge bg-success m-0">58%</label>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className="text-right">
                          <label className="badge bg-danger m-0">30%</label>
                        </td>
                      </tr>
                      <tr>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          <label className="badge bg-primary m-0">40%</label>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className="text-right">
                          <label className="badge bg-warning m-0">60%</label>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className="text-right">
                          <label className="badge bg-success m-0">50%</label>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td className="text-right">
                          <label className="badge bg-primary m-0">90%</label>
                        </td>
                      </tr>
                    </tbody>
                  </Table>
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>19-11-2018</td>
                        <td>
                          <label className="badge bg-primary mr-1">Sketch</label>
                          <label className="badge bg-danger">Ui</label>
                        </td>
                        <td>
                          <Link to="#">
                            <i className="icon feather icon-edit f-16 text-c-green" />
                      ...
                      <tr>
                        ...
                        <td>10-10-2017</td>
                        <td>
                          <label className="badge bg-primary mr-1">Ux</label>
                          <label className="badge bg-danger mr-1">Ui</label>
                          <label className="badge bg-info">php</label>
                        </td>
                        <td>
                          <Link to="#">
                            <i className="icon feather icon-edit f-16 text-c-green" />
                      ...
                      <tr>
                        ...
                        <td>16-03-2018</td>
                        <td>
                          <label className="badge bg-danger mr-1">Sketch</label>
                          <label className="badge bg-warning">Ui</label>
                        </td>
                        <td>
                          <Link to="#">
                            <i className="icon feather icon-edit f-16 text-c-green" />
                      ...
                      <tr>
                        ...
                        <td>19-11-2018</td>
                        <td>
                          <label className="badge bg-info mr-1">Ux</label>
                          <label className="badge bg-success mr-1">Ui</label>
                          <label className="badge bg-warning">php</label>
                        </td>
                        <td>
                          <Link to="#">
                            <i className="icon feather icon-edit f-16 text-c-green" />
                      ...
                      <tr>
                        ...
                        <td>
                          <label className="badge bg-primary mr-1">Sketch</label>
                          <label className="badge bg-info">Ui</label>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>25-11-2018</td>
                        <td>
                          <label className="badge bg-warning mr-1">Ux</label>
                          <label className="badge bg-danger mr-1">Ui</label>
                          <label className="badge bg-success">php</label>
                        </td>
                        <td>
                          <Link to="#">
                            <i className="icon feather icon-edit f-16 text-c-green" />
                      ...
                      <tr>
                        ...
                        <td>
                          <label className="badge bg-danger mr-1">Sketch</label>
                          <label className="badge bg-primary">Ui</label>
                        </td>
                        <td>
                          <Link to="#">
                            <i className="icon feather icon-edit f-16 text-c-green" />
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>abc@gmail.com</td>
                        <td>
                          <label className="badge bg-danger">Out Stock</label>
                        </td>
                        <td>
                          <Link to="#">
                      ...
                      <tr>
                        ...
                        <td>cdc@gmail.com</td>
                        <td>
                          <label className="badge bg-success">In Stock</label>
                        </td>
                        <td>
                          <Link to="#">
                            <i className="fa fa-star f-14 text-c-yellow" />
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Task</td>
                        <td>
                          <label className="badge bg-danger">Open</label>
                        </td>
                        <td>John Malit</td>
                        <td>Normal</td>
                        <td>8/8/2017</td>
                      ...
                      <tr>
                        ...
                        <td>Task</td>
                        <td>
                          <label className="badge bg-primary">New</label>
                        </td>
                        <td>Ken Malit</td>
                        <td>low</td>
                        <td>6/7/2017</td>
                      ...
                      <tr>
                        ...
                        <td>Task</td>
                        <td>
                          <label className="badge bg-success">Close</label>
                        </td>
                        <td>Ken Malit</td>
                        <td>Normal</td>
                        <td>9/4/2017</td>
              ...
              <PerfectScrollbar>
                <Card.Body>
                  <div className="row m-b-25 m-t-5 align-items-center">
                    <div className="col-auto p-r-0">
                      <i className="feather icon-bell bg-primary feed-icon" />
                    </div>
                    <div className="col">
                      <Link to="#">
                        <h6 className="m-b-5">
                  ...
                  <div className="row m-b-25 align-items-center">
                    <div className="col-auto p-r-0">
                      <i className="feather icon-shopping-cart bg-danger feed-icon" />
                    </div>
                    <div className="col">
                      <Link to="#">
                        <h6 className="m-b-5">
                  ...
                  <div className="row m-b-25 align-items-center">
                    <div className="col-auto p-r-0">
                      <i className="feather icon-file-text bg-success feed-icon" />
                    </div>
                    <div className="col">
                      <Link to="#">
                        <h6 className="m-b-5">
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>$ 16,244</td>
                        <td>
                          <Link to="#" className=" badge bg-primary f-12">
                            Active
                          </Link>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>$ 3,937</td>
                        <td>
                          <Link to="#" className="badge bg-warning f-12">
                            Not Active
                          </Link>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>$ 28,039</td>
                        <td>
                          <Link to="#" className="badge bg-success f-12">
                            Paused
                          </Link>
                        </td>
                      </tr>
                  ...
                  <Table responsive>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>$ 235.34</td>
                        <td>
                          <Link to="#" className="badge bg-warning">
                            Not Active
                          </Link>
                        </td>
                        <td className="text-right">
                  ...
                  <Table responsive>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <Link to="#" className="badge bg-primary rounded-pill f-12 mr-2">
                            Reject
                          </Link>
                          <Link to="#" className="badge bg-success rounded-pill f-12 mr-2">
                            Approve
                          </Link>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <Link to="#" className="badge bg-danger rounded-pill f-12 mr-2">
                            Reject
                          </Link>
                          <Link to="#" className="badge bg-warning rounded-pill f-12 mr-2">
                            Approve
                          </Link>
                        </td>
                      </tr>
